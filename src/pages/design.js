...
const AlbumBack = () => (
	<Image alt='An album back design' route='album-back' src={albumBack} />
);

const AlbumCover = () => (
	<Image alt='An album cover design' route='album-cover' src={albumCover} />
);

const AlbumDisc = () => (
	<Image alt='An album disc design' route='album-disc' src={albumDisc} />
);
...
const Graffiti = () => (
	<Image alt='My graffiti artwork of my name' route='graffiti' src={graffiti} />
);

const Hoth = () => <Image alt='Alterations of Hoth' route='hoth' src={hoth} />;

const JunkShip = () => (
	<Image alt='A junk ship' route='junk-ship' src={junkShip} />
);
...
const Magazine = () => (
	<Image alt='A magazine cover of myself' route='magazine' src={magazine} />
);

const Mandala = () => (
	<Image alt='My mandala I made' route='mandala' src={mandala} />
);

const NatureEffect = () => (
	<Image alt='Nature effects' route='nature-effect' src={natureEffect} />
);

const Poster = () => (
	<Image alt='My propaganda poster' route='poster' src={poster} />
);

const Robot = () => <Image alt='A robot character' route='robot' src={robot} />;

const SMHSMagazine = () => (
	<Image alt='A magazine cover' route='smhs-magazine' src={smhsMagazine} />
);
